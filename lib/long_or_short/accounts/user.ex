defmodule LongOrShort.Accounts.User do
  use Ash.Resource,
  ...
  authentication do
    add_ons do
      ...
      confirmation :confirm_new_user do
        ...
        sender LongOrShort.Accounts.User.Senders.SendNewUserConfirmationEmail
      end
    end

    tokens do
      enabled? true
      token_resource LongOrShort.Accounts.Token
      signing_secret LongOrShort.Secrets
    ...
    strategies do
      password :password do
        ...
        resettable do
          sender LongOrShort.Accounts.User.Senders.SendPasswordResetEmail
